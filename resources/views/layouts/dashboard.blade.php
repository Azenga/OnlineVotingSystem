            ...
            <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
                ...
                <li class="nav-item">
                    ...
                    <div id="levels-dropdown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            ...
                            <a class="collapse-item" href="buttons.html">Browse Levels</a>
                            <a class="collapse-item" href="cards.html">Add Level</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="positions-dropdown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Quick Actions</h6>
                            <a class="collapse-item" href="buttons.html">Browse Positions</a>
                            <a class="collapse-item" href="cards.html">Add Position</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="stations-dropdown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Quick Actions</h6>
                            <a class="collapse-item" href="buttons.html">Browse Stations</a>
                            <a class="collapse-item" href="cards.html">Add Station</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="counties-dropdown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Quick Actions</h6>
                            <a class="collapse-item" href="buttons.html">Browse Counties</a>
                            <a class="collapse-item" href="cards.html">Add County</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="constituencies-dropdown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Quick Actions</h6>
                            <a class="collapse-item" href="buttons.html">Browse Constituencies</a>
                            <a class="collapse-item" href="cards.html">Add Constituency</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="wards-dropdown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Quick Actions</h6>
                            <a class="collapse-item" href="buttons.html">Browse Wards</a>
                            <a class="collapse-item" href="cards.html">Add Ward</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="voters-dropdown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Quick Actions</h6>
                            <a class="collapse-item" href="buttons.html">Browse Voters</a>
                            <a class="collapse-item" href="cards.html">Add Voter</a>
                        </div>
                    </div>
                </li>         
                ...
                <li class="nav-item">
                    ...
                    <div id="candidates-dropdown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Quick Actions</h6>
                            <a class="collapse-item" href="buttons.html">Browse Candidates</a>
                            <a class="collapse-item" href="cards.html">Add Candidate</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="officers-dropdown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Quick Actions</h6>
                            <a class="collapse-item" href="buttons.html">Browse Officers</a>
                        </div>
                    </div>
                </li>                
                ...
                <li class="nav-item">
                    ...
                    <div id="roles-dropdown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Quick Actions</h6>
                            <a class="collapse-item" href="buttons.html">Browse Roles</a>
                            <a class="collapse-item" href="buttons.html">Add Role</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <div id="permissions-dropdown" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                        <div class="bg-white py-2 collapse-inner rounded">
                            <h6 class="collapse-header">Quick Actions</h6>
                            <a class="collapse-item" href="buttons.html">Browse Permissions</a>
                        ...
                        <ul class="navbar-nav ml-auto">
                            ...
                            <li class="nav-item dropdown no-arrow">
                                <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                    data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                    <span class="mr-2 d-none d-lg-inline text-gray-600 small">Azenga Kevin</span>
